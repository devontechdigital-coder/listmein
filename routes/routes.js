...
import {
  UserloginAll, SignupAdmin, Adminlogin, getAllGalleryController, deleteGalleryController, AddAdminBlogController, AdmindeleteBlogController, AddAdminCategoryController,AddAdminHomeCategoryController,
 getAllReviewsAdmin, AdmingetAllCategories, AddAdminProduct, getAllcategoryFillAdmin,getAllHomeCategoryFillAdmin, updateCategoryAdmin, updateHomeCategoryAdmin, getCategoryIdAdmin, deleteCategoryAdmin,  getHomeCategoryIdAdmin, deleteHomeCategoryAdmin, getAllProductFillAdmin, updateProductAdmin, getProductIdAdmin, deleteProductAdmin,
...
import {
  ...
  updateVendorProfileUser, adsImage, getAllAdsFillAdmin,BuyAdsPlanByUser,AdsPaymentVerification,AdsUserPaymentVerification,editFullOrderAdmin,OrderPaymentVerification,CreateVendorProfileUser,paymentVerification, BuyPlanAddUser, BuyPlanByUser, PayuHash, userPlanIdController,ViewAllZonesCategory, ViewAllZonesDepartment, getVendorById, HomeSendvendorEnquire, ApplyEnquireStatus, SenderEnquireStatus, AllPayment, downloadUserInvoice, checkUserPlan, GetWebsiteData, GetWebsiteData_old
...
router.post('/admin/add-home-category', AddAdminHomeCategoryController);
router.get('/admin/all-home-category-fillter', getAllHomeCategoryFillAdmin);
router.get('/admin/get-home-category/:id', getHomeCategoryIdAdmin);
router.put('/admin/update-home-category/:id', updateHomeCategoryAdmin);
router.delete('/admin/delete-home-category/:id', deleteHomeCategoryAdmin);
router.get('/all-home-category', UsergetAllHomeCategories);
...
router.put('/admin/update-lead/:id', editLeadStatusAdmin);
 router.post('/admin/employee/accept-job', EmployeeAcceptOrderControllerAdmin);
 

router.get('/admin/all-user', getAllUserAdmin);

router.get('/admin/my-user', getMYUserAdmin);
...
router.post("/buy-ads-by-user", adsImage, BuyAdsPlanByUser);

router.get("/admin/all-ads-fillter", getAllAdsFillAdmin);



router.post("/ads-payment-verification", AdsPaymentVerification);

router.post("/user-ads-payment-verification", AdsUserPaymentVerification);
